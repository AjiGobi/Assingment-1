...
#btn{
    ...
    <body>
        ...
        <br><br><br><br>
        <div>
            <center><h1 id ="welcomeHeading">Search Main Classifications</h1></center>
        </div>
            
    <div class="container" > 
        <form action=" MainSearchController">
        <table class="info" align="center">
        <tr>  
            <th scope="col"><label for="Book Id"><b>Main Classification Id</b></label></th>
            <th scope="col"> <input type="text" placeholder="Enter main classification Id" name="mainId" ></th>
        </tr> 
        <tr> 
            <th scope="col"><label for="Title"><b>Main Classification Name</b></label></th>
            <th scope="col"><input type="text" placeholder="Enter main classification name" name="mainName" ></th>
        </tr>
        </table>
