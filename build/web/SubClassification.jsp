...
#btn{
    ...
    <body>
        ...
        <br><br><br><br>
        <div>
            <center><h1 id ="welcomeHeading">ADD Sub Classifications</h1></center>
        </div>
            
    <div class="container" > 
        <form action="SubAddControl" method="get">
        <table class="info" align="center">
        <tr>   
         <th scope="col"><label for="Book Id"><b> Sub_classification Id</b></label></th>
         <th scope="col"><input type="text" placeholder="Enter sub id" name="SubId" required></th>
        </tr>
        <tr>
         <th scope="col"><label for="Title"><b>Sub_classification Name</b></label></th>
         <th scope="col"><input type="text" placeholder="Enter sub name" name="SubName" required></th>
        </tr>
       <tr>
