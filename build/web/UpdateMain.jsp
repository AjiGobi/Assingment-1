...
#btn{
    ...
    <body>
      ...
      <div class="navbar navbar-inverse"  width="100%">
        ...
        <br><br><br><br>
        <div>
            <center><h1 id ="welcomeHeading">Update main classifications</h1></center>
        </div>
            
    <div class="container" > 
        <form action="MainUpdateController">
         <table class="info" align="center">
        <tr>
            <th scope="col"><label for="Book Id"><b>Main Classification Id</b></label></th>
            <th scope="col"><input type="text" placeholder="Enter main id" name="id" required></th>
        </tr> 
        <tr>
            <th scope="col"><label for="Title"><b>Main Classification Name</b></label></th>
            <th scope="col"><input type="text" placeholder="Enter main name" name="mainclassification" required></th>
        </tr>
         </table>
