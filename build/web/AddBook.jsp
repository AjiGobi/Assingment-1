...
#btn{
    ...
    <div class="container" >
        ...
        <tr class="info">  
            <th scope="col"><label for="Book Id"><b>Book Id</b></label></th>
            <th scope="col"><input type="text" placeholder="Enter Book Id" name="bookId" value="${bookId}" required></th>
         </tr>
       
        <tr>
            <th scope="col"><label for="Title"><b>Title</b></label></th>
            <th scope="col"><input type="text" placeholder="Enter Title" name="title"  value="${title}"required></th>
        </tr>
        <tr>
        <th scope="col"><label for="Author"><b>Author</b></label>
        <th scope="col"><input type="text" placeholder="Enter Author" name="author"  value="${author}" required>
        </tr>
      
        
        <tr>
        <th scope="col" style=""><label for="Main classification"><b>Main classification</b></label></th>
        <th scope="col"> <select style="width:300px;" name="mainClassification"  onchange="selectvalue(form);">
        ...
        <tr>
        <th scope="col" style=""><label for="Sub classification"><b>Sub_classification</b></label></th>
        <th> <select style="width:300px;" name="subClassification">
                     <option value="" Selected disabled hidden>Select the main classification</option>
                        <c:forEach items="${listSubCategory}" var="category">
                                ...
                                <c:if test="${category.mainId eq selectedCatId2}">selected="selected"</c:if>>
        ...
        <tr>
        <th scope="col"><label for="Year of publishing"><b>Year of publishing</b></label></th>
        <th scope="col"><input type="text" placeholder="Enter Year of Publishing" name="yearOfPublishing" value="${yearOfPublishing}" required></th>
        </tr>
         <tr>
        <th scope="col"><label for="Last printed year"><b>Last printed year</b></label></th>
        <th scope="col"><input type="text" placeholder="Enter Last Printed Year" name="lastPrintedYear"  value="${lastPrintedYear}" required></th>
         </tr>
         <tr>
        <th scope="col"><label for="ISBN no"><b>ISBN no</b></label></th>
        <th scope="col"><input type="text" placeholder="Enter Isbn no" name="isbnNo"  value="${isbnNo}" required></th>
         </tr>
         <tr>
        <th scope="col"><label for="No of pages"><b>No of pages</b></label></th>
        <th scope="col"><input type="text" placeholder="Enter No of pages " name="noOfPages"  value="${noOfPages}" required></th>
         </tr>
        </table>
        <div id="btn" class="kk">
