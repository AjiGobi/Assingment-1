...
#btn{
    ...
    <body>
        ...
        <br><br><br><br><br>
        <div>
            <center><h1 id ="welcomeHeading">Delete Sub Classifiactions</h1></center>
        </div>
            
    <div class="container" > 
        <form action="SubDelController">
         <table class="info" align="center"> 
        <tr>
            <th scope="col"><label for="Book Id"><b> Sub_classification Id</b></label></th>
            <th scope="col"><input type="text" placeholder="Enter Sub Id" name="id" required></th>
         ...
         <div id="btn" class="kk">
        <button class="btn btn-primary" type="submit" align="center">Delete</button>
        </div>
        </form>
