...
#btn{
    ...
    <body>
       ...
       <div class="navbar navbar-inverse"  width="100%">
        ...
        <br><br><br><br><br>
        <div>
            <center><h1 id ="welcomeHeading">Delete Main Classification</h1></center>
        </div>
            
    <div class="container" > 
        <form action="MainDelController">
        <table class="info" align="center">
        <tr >  
            <th scope="col"><label for="Book Id"><b>Main Classification Id</b></label></th>&nbsp;&nbsp;&nbsp;&nbsp;
        <th scope="col"><input type="text" placeholder="Enter Book Id" name="id" required></th>
        </tr>
        </table>
