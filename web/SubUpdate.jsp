...
<div class="navbar navbar-inverse"  width="100%">
    ...
    <div class="container" > 
        <form action="SubUpdateController">
        <label for="Book Id"><b> Sub_classification Id</b></label>
        <input type="text" placeholder="Enter Username" name="id" required>

        <label for="Title"><b>Sub_classification Name</b></label>
        <input type="text" placeholder="Enter Password" name="subclassification" required>
        
        <label for="Title"><b>Main Classification Name</b></label>
        <input type="text" placeholder="Enter Password" name="mainclassification" required>
