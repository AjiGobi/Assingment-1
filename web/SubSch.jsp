...
#btn{
    ...
    <body>
        ...
        <br><br><br><br>
        <div>
            <center><h1 id ="welcomeHeading">Search sub classifications</h1></center>
        </div>
            
    <div class="container" > 
        <form action="SubSearchController">
        <table class="info" align="center">
         <tr >
          <th scope="col"><label for="Book Id"><b> Sub_classification Id</b></label></th>
          <th scope="col"><input type="text" placeholder="Enter sub id" name="subId" ></th>
         </tr>
        <tr >
          <th scope="col"><label for="Title"><b>Sub_classification Name</b></label></th>
          <th scope="col"><input type="text" placeholder="Enter sub name" name="sName" ></th>
         </tr>
        <tr >
            <th scope="col"><label for="Title"><b>Main Classification Name</b></label></th>
          <th scope="col"><input type="text" placeholder="Enter main id" name="mName" ></th>
        </tr>
        </table>
        <div id="btn" class="kk">
        <button class="btn btn-primary" type="submit" align="center">Search</button>
        </div>
        </form>
