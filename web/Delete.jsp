...
#btn{
    ...
    <body>
        ...
        <div class="navbar navbar-inverse"  width="100%">
         ...
         <br><br><br><br><br>
        <div>
            <center><h1 id ="welcomeHeading">Delete Books</h1></center>
        </div>
            
    <div class="container" >
        <form action="DelController">
        <table class="info" align="center">  
         <tr>    
             <th scope="col"><label for="Book Id"><b>Book Id</b></label></th> <br>
             <th scope="col"><input type="text" placeholder="Enter BookId" name="bookid" required></th>
        </tr>
        </table>
            <br><br><br>
        <div id="btn" class="kk">
